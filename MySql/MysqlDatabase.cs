...
namespace Infinitum.Databases {
    public sealed class MySql : Database {
        ...
        public MySql(string server, string database, string user_id, string password) {
            this.server = server;
            ...
            try {
                connection = new MySqlConnection(lastQuery);
            } catch (Exception ex) {
        ...
        public override bool Insert(string table, string values, string columns = null) {
            try {
                ...
                if (this.EstablishConnection()) {
                    MySqlCommand cmd = new MySqlCommand(lastQuery, connection);
